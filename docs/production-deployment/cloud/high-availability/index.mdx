...
- **High availability Namespaces** offer a 99.99% Service Level Agreement ([SLA](/cloud/sla)) for workloads with strict high availability needs.
  ...
  High availability Namespaces's 99.99% availability is enforced by Temporal Cloud's [service error rates SLA](https://docs.temporal.io/cloud/sla).
